...
const TemporaireEmployesPage = () => {
  ...
  <div className="d-flex justify-content-end gap-2">
    {(!roles.includes('Employe')) && (
      <button
        className="d-flex align-items-center justify-content-center rounded-circle shadow-sm p-2 btn-hover"
        style={{ width: "40px", height: "40px", backgroundColor: "#d9faf0", color: "#048760" }}
        onClick={() => handleAffectUser(user.id)}
        title="Affecter à mon département et société"
      >
        <Icon icon="mdi:account-convert" className="fs-5" />
      </button>
    )}
  </div>
</td>
